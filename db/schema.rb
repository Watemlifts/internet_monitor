...
ActiveRecord::Schema.define(version: 20_170_823_181_764) do
  ...
  add_index 'refinery_authentication_devise_roles_users', %w[role_id user_id],
            name: 'refinery_roles_users_role_id_user_id', using: :btree
  add_index 'refinery_authentication_devise_roles_users', %w[user_id role_id],
            name: 'refinery_roles_users_user_id_role_id', using: :btree
  ...
  add_index 'refinery_authentication_devise_user_plugins', ['name'],
            name: 'index_refinery_authentication_devise_user_plugins_on_name', using: :btree
  add_index 'refinery_authentication_devise_user_plugins', %w[user_id name],
            name: 'refinery_user_plugins_user_id_name', unique: true, using: :btree
  ...
  add_index 'refinery_authentication_devise_users', ['id'], name: 'index_refinery_authentication_devise_users_on_id',
                                                            using: :btree
  add_index 'refinery_authentication_devise_users', ['slug'],
            name: 'index_refinery_authentication_devise_users_on_slug', using: :btree
  ...
  add_index 'refinery_blog_categories_blog_posts', %w[blog_category_id blog_post_id],
            name: 'index_blog_categories_blog_posts_on_bc_and_bp', using: :btree
  ...
  add_index 'refinery_blog_category_translations', ['locale'],
            name: 'index_refinery_blog_category_translations_on_locale', using: :btree
  add_index 'refinery_blog_category_translations', ['refinery_blog_category_id'],
            name: 'index_a0315945e6213bbe0610724da0ee2de681b77c31', using: :btree
  ...
  add_index 'refinery_blog_post_translations', ['refinery_blog_post_id'],
            name: 'index_refinery_blog_post_translations_on_refinery_blog_post_id', using: :btree
  ...
  add_index 'refinery_image_translations', ['refinery_image_id'],
            name: 'index_refinery_image_translations_on_refinery_image_id', using: :btree
  ...
  add_index 'refinery_page_part_translations', ['refinery_page_part_id'],
            name: 'index_refinery_page_part_translations_on_refinery_page_part_id', using: :btree
  ...
  add_index 'refinery_page_translations', ['refinery_page_id'],
            name: 'index_refinery_page_translations_on_refinery_page_id', using: :btree
  ...
  add_index 'refinery_resource_translations', ['refinery_resource_id'],
            name: 'index_refinery_resource_translations_on_refinery_resource_id', using: :btree
  ...
  add_index 'seo_meta', %w[seo_meta_id seo_meta_type], name: 'index_seo_meta_on_seo_meta_id_and_seo_meta_type',
                                                       using: :btree
  ...
  add_index 'taggings', %w[tag_id taggable_id taggable_type context tagger_id tagger_type],
            name: 'taggings_idx', unique: true, using: :btree
